...
class Centros_Model { //declaración de la clase

    var $idCentro; // declaración del atributo email
    var $nombreEmpresa; // declaración del atributo nombre
        ...
        if (($this->email <> '')){ // si el atributo clave de la entidad no esta vacio
            ...
            if (!$result = $this->mysqli->query($sql)){ // si da error la ejecución de la query
                ...
                if ($result->num_rows == 0){ // miramos si el resultado de la consulta es vacio (no existe el login)
                    ...
                    $sql = "INSERT INTO CENTROS (idcentro,nombreEmpresa)
				VALUES ('".$this->idCentro."','".$this->nombreEmpresa."')";
...
// hace una búsqueda en la tabla con los datos proporcionados. Si van vacios devuelve todos
    function SEARCH()
    {
        ...
        $sql = "SELECT *
       			from CENTROS
				where idCentro LIKE '%".$this->idCentro."%' AND
						nombreEmpresa LIKE '%".$this->nombreEmpresa."%'";
...
// se manda un mensaje de que ese valor de clave no existe
    function DELETE()
    {
        ...
        if ($result->num_rows == 1) // si existe una tupla con ese valor de clave
        {
            ...
            $sql = "DELETE FROM CENTROS WHERE (idCentro = '".$this->idCentro."')";
...
// en el atributo de la clase
    function RellenaDatos()
    {
        ...
        $sql = "SELECT * FROM CENTROS WHERE idCentros = '".$this->idCentros."'";
