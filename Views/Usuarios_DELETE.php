...
<form name="delete" method="post" action="../Controllers/Usuarios_Controller.php">
	<input type ="hidden" name="login"  value="<?php echo $this->valores[0];?>">
	<input type ="hidden" name="DNI"  value="<?php echo $this->valores[2];?>">
	<input type ="hidden" name="email"  value="<?php echo $this->valores[6];?>">
