...
function mostrar(){
	...
	?>
<article id="add">
					<h2> <?php echo $GLOBALS['strings']['Añadir empresa'];?> </h2>
<form name="Add" method="post" action="../Controllers/Empresas_Controller.php"
>

<label><?php echo $GLOBALS['strings']['Nombre de empresa'];?> </label><input type="text"  name="nombreEmpresa" maxlength="30" size="22" required onblur="comprobarTexto(this,10)">
		<br>
