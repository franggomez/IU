...
<tr>
	<th class="centrado" colspan="4"><?php echo $GLOBALS['strings']['Lista de incidencias'];?></th>
	<td><form action="../Controllers/Incidencias_Controller.php"
...
<tr>
	...
	<th><?php echo $GLOBALS['strings']['Numero de incidencia'];?></th>
...
<td><form action="../Controllers/Incidencias_Controller.php"
	method="POST">
	<input type="hidden" name="numIncidencia" value="<?php echo $fila[0]; ?>" >
