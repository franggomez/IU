...
<tr>
	<th class="centrado" colspan="4"><?php echo $GLOBALS['strings']['Lista de centros'];?></th>
	<td><form action="../Controllers/Centros_Controller.php"
...
<th><?php echo $GLOBALS['strings']['Nombre de la empresa'];?></th>
...
<td><form action="../Controllers/Centros_Controller.php"
	method="POST">
	<input type="hidden" name="idCentro" value="<?php echo $fila[0]; ?>" >
