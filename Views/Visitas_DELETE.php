...
<article id="delete" class="datagrid">
	...
	<tr>
		<th><?php echo $GLOBALS['strings']['Identificador de visita'];?></th><td><?php echo $this->valores[0];?></td>
	</tr>
	<tr>
	...
	<tr>
		<th><?php echo $GLOBALS['strings']['Identificador de contrato'];?></th><td> <?php echo $this->valores[5];?></td>
	</tr>



</table>
<form name="delete" method="post" action="../Controllers/Visitas_Controller.php">
	<input type ="hidden" name="idVisita"  value="<?php echo $this->valores[0];?>">
