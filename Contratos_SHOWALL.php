...
<tr>
	<th class="centrado" colspan="4"><?php echo $GLOBALS['strings']['Lista de contratos'];?></th>
	<td><form action="../Controllers/Contratos_Controller.php"
...
<th><?php echo $GLOBALS['strings']['Importe'];?></th>
<th><?php echo $GLOBALS['strings']['Fecha de finalizacion'];?></th>
<th><?php echo $GLOBALS['strings']['Documento de contrato'];?></th>
...
<td><form action="../Controllers/Contratos_Controller.php"
	method="POST">
	<input type="hidden" name="idContrato" value="<?php echo $fila[0]; ?>" >
